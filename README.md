...
[![Version](https://img.shields.io/badge/version-1.11.0-blue)](https://github.com/DesvoSoft/Vitra)
...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/gh/DesvoSoft/Vitra@v1.11.0/dist/vitra.min.css" integrity="sha256-..." crossorigin="anonymous">

<!-- Optional: Modular JS Engine (Fixed version with SRI) -->
<script src="https://cdn.jsdelivr.net/gh/DesvoSoft/Vitra@v1.11.0/dist/vitra.min.js" integrity="sha256-..." crossorigin="anonymous" defer></script>
```

> **Note:** Always use a pinned version (e.g., `@v1.11.0`) for production. The SRI hashes are generated during build and stored in `dist/SRI.txt`.
